...
pub fn test_create_from_vec() {
    let mut list = ConsList::create_from_vec(&vec![
        "aB".to_string(),
        "cD".to_string(),
        "i_j".to_string(),
        "gh".to_string(),
    ...
    assert!(
        list.content() == vec!["b2".to_string(), "d4".to_string()]
            && list.size() == 2
            && !list.empty()
    );
...
pub fn test_iter_with_lambda() {
    let list = ConsList::create_from_vec(&vec![
        "aB".to_string(),
        "cD".to_string(),
        "i_j".to_string(),
        "gh".to_string(),
...
pub fn test_push_front() {
    ...
    assert!(
        list.content() == vec!["second_new_val".to_string(), "bbq".to_string()] && list.size() == 2
    );
...
pub fn test_push_back() {
    ...
    assert!(
        list.content() == vec!["bbq".to_string(), "second_new_val".to_string()] && list.size() == 2
    );
...
pub fn test_insert() {
    ...
    list = ConsList::create_from_vec(&vec![
        "aB".to_string(),
        "cD".to_string(),
        "i_j".to_string(),
        "gh".to_string(),
    ...
    assert!(
        result == Err(InvalidIndex)
            && list.content() == vec!["af".to_string(), "d_8".to_string(), "Z-4".to_string()]
            && list.size() == 3
    );
    ...
    assert!(
        result == Ok(0)
            && list.content() == vec!["third_val".to_string(), "b2".to_string(), "d4".to_string()]
            && list.size() == 3
    );
    ...
    assert!(
        result == Ok(1)
            && list.content() == vec!["b2".to_string(), "third_val".to_string(), "d4".to_string()]
            && list.size() == 3
    );
    ...
    assert!(
        result == Ok(2)
            && list.content() == vec!["b2".to_string(), "d4".to_string(), "third_val".to_string()]
            && list.size() == 3
    );
    ...
    assert!(
        result == Ok(0)
            && list.content() == vec!["fourth_val".to_string(), "bbq".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        result == Ok(1)
            && list.content() == vec!["bbq".to_string(), "fourth_val".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        result == Err(InvalidIndex)
            && list.content() == vec!["bbq".to_string()]
            && list.size() == 1
    );
...
pub fn test_remove() {
    ...
    assert!(
        result.unwrap() == "af".to_string()
            && list.content() == vec!["d_8".to_string(), "Z-4".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        result.unwrap() == "d_8".to_string()
            && list.content() == vec!["af".to_string(), "Z-4".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        result.unwrap() == "Z-4".to_string()
            && list.content() == vec!["af".to_string(), "d_8".to_string()]
            && list.size() == 2
    );
...
pub fn test_merge() {
    ...
    assert!(
        first_list.content() == vec!["b2".to_string(), "d4".to_string()] && first_list.size() == 2
    );
    assert!(second_list.empty());
    ...
    assert!(
        first_list.content() == vec!["b2".to_string(), "d4".to_string(), "bbq".to_string()]
            && first_list.size() == 3
    );
    assert!(second_list.empty());
    ...
    assert!(
        first_list.content() == vec!["bbq".to_string(), "b2".to_string(), "d4".to_string()]
            && first_list.size() == 3
    );
    assert!(second_list.empty());

    first_list = ConsList::create_from_vec(&vec![
        "a1".to_string(),
        "b2".to_string(),
        "c3".to_string(),
        "d4".to_string(),
    ...
    second_list = ConsList::create_from_vec(&vec![
        "f6".to_string(),
        "g7".to_string(),
        "h8".to_string(),
        "i9".to_string(),
...
#[test]
pub fn test_split() {
    let mut first_list = ConsList::create_from_vec(&vec![
        "a1".to_string(),
        "b2".to_string(),
        "c3".to_string(),
        "d4".to_string(),
    ...
    assert!(
        second_list.content() == vec!["h8".to_string(), "i9".to_string()]
            && second_list.size() == 2
    );
    ...
    first_list =
        ConsList::create_from_vec(&vec!["b2".to_string(), "d4".to_string(), "bbq".to_string()]);
    second_list = ConsList::create();
    ...
    assert!(first_list.empty());
    assert!(
        second_list.content() == vec!["b2".to_string(), "d4".to_string(), "bbq".to_string()]
            && second_list.size() == 3
    );
    ...
    assert!(
        second_list.content() == vec!["d4".to_string(), "bbq".to_string()]
            && second_list.size() == 2
    );
    ...
    assert!(first_list.empty());
    assert!(
        second_list.content() == vec!["b2".to_string(), "d4".to_string()]
            && second_list.size() == 2
    );
    ...
    assert!(
        first_list.content() == vec!["a1".to_string(), "b2".to_string(), "c3".to_string()]
            && first_list.size() == 3
    );
    assert!(
        second_list.content()
...
pub fn test_at() {
    ...
    assert!(
        list.content() == vec!["kl".to_string(), "m_n".to_string(), "O/p".to_string()]
            && list.size() == 3
    );
