...
pub fn test_create_from_vec() {
    let mut list = create_rc_ro_list_from_vec(&vec![
        "aB".to_string(),
        "cD".to_string(),
        "i_j".to_string(),
        "gh".to_string(),
    ...
    assert!(
        ro_values(&list.content()) == vec!["b2".to_string(), "d4".to_string()]
            && list.size() == 2
            && !list.empty()
    );
    ...
    assert!(
        ro_values(&list.content()) == vec!["bbq".to_string()] && list.size() == 1 && !list.empty()
    );
...
pub fn test_iter_with_lambda() {
    let list = create_rc_ro_list_from_vec(&vec![
        "aB".to_string(),
        "cD".to_string(),
        "i_j".to_string(),
        "gh".to_string(),
...
pub fn test_push_front() {
    ...
    assert!(
        ro_values(&list.content()) == vec!["second_new_val".to_string(), "bbq".to_string()]
            && list.size() == 2
    );
...
pub fn test_pop_front() {
    ...
    assert!(
        *result.unwrap() == "b2".to_string()
            && ro_values(&list.content()) == vec!["d4".to_string()]
            && list.size() == 1
    );
...
pub fn test_push_back() {
    ...
    assert!(
        ro_values(&list.content()) == vec!["bbq".to_string(), "second_new_val".to_string()]
            && list.size() == 2
    );
...
pub fn test_pop_back() {
    ...
    assert!(
        *result.unwrap() == "d4".to_string()
            && ro_values(&list.content()) == vec!["b2".to_string()]
            && list.size() == 1
    );
...
pub fn test_insert() {
    ...
    list = create_rc_ro_list_from_vec(&vec![
        "aB".to_string(),
        "cD".to_string(),
        "i_j".to_string(),
        "gh".to_string(),
    ...
    assert!(
        result == Ok(0)
            && ro_values(&list.content()) == vec!["fourth_val".to_string(), "bbq".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        result == Ok(1)
            && ro_values(&list.content()) == vec!["bbq".to_string(), "fourth_val".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        result == Err(InvalidIndex)
            && ro_values(&list.content()) == vec!["bbq".to_string()]
            && list.size() == 1
    );
    ...
    assert!(
        result == Ok(0)
            && ro_values(&list.content()) == vec!["fifth_val".to_string()]
            && list.size() == 1
    );
...
pub fn test_remove() {
    ...
    assert!(
        *result.unwrap() == "af".to_string()
            && ro_values(&list.content()) == vec!["d_8".to_string(), "Z-4".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        *result.unwrap() == "d_8".to_string()
            && ro_values(&list.content()) == vec!["af".to_string(), "Z-4".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        *result.unwrap() == "Z-4".to_string()
            && ro_values(&list.content()) == vec!["af".to_string(), "d_8".to_string()]
            && list.size() == 2
    );
...
pub fn test_reverse() {
    ...
    assert!(
        ro_values(&list.content()) == vec!["d4".to_string(), "b2".to_string()] && list.size() == 2
    );
...
pub fn test_merge() {
    ...
    assert!(
        ro_values(&first_list.content()) == vec!["b2".to_string(), "d4".to_string()]
            && first_list.size() == 2
    );
    assert!(second_list.empty());
    ...
    first_list = create_rc_ro_list_from_vec(&vec![
        "a1".to_string(),
        "b2".to_string(),
        "c3".to_string(),
        "d4".to_string(),
    ...
    second_list = create_rc_ro_list_from_vec(&vec![
        "f6".to_string(),
        "g7".to_string(),
        "h8".to_string(),
        "i9".to_string(),
...
#[test]
pub fn test_split() {
    let mut first_list = create_rc_ro_list_from_vec(&vec![
        "a1".to_string(),
        "b2".to_string(),
        "c3".to_string(),
        "d4".to_string(),
    ...
    assert!(
        ro_values(&second_list.content()) == vec!["h8".to_string(), "i9".to_string()]
            && second_list.size() == 2
    );
    ...
    first_list =
        create_rc_ro_list_from_vec(&vec!["b2".to_string(), "d4".to_string(), "bbq".to_string()]);
    second_list = ConsList::create();
    ...
    assert!(
        ro_values(&second_list.content()) == vec!["d4".to_string(), "bbq".to_string()]
            && second_list.size() == 2
    );
    ...
    assert!(
        ro_values(&second_list.content()) == vec!["bbq".to_string()] && second_list.size() == 1
    );
    ...
    assert!(first_list.empty());
    assert!(
        ro_values(&second_list.content()) == vec!["b2".to_string(), "d4".to_string()]
            && second_list.size() == 2
    );
...
pub fn test_at() {
    ...
    assert!(
        ro_values(&list.content()) == vec!["kl".to_string(), "m_n".to_string(), "O/p".to_string()]
            && list.size() == 3
    );
    ...
    assert!(
        ro_values(&list.content()) == vec!["b2".to_string(), "d4".to_string()] && list.size() == 2
    );
