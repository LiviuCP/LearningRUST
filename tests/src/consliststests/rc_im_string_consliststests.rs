...
pub fn test_create_from_vec() {
    let mut list = create_rc_im_list_from_vec(&vec![
        "aB".to_string(),
        "cD".to_string(),
        "i_j".to_string(),
        "gh".to_string(),
    ...
    assert!(
        values(&list.content()) == vec!["b2".to_string(), "d4".to_string()]
            && list.size() == 2
            && !list.empty()
    );
    ...
    assert!(
        values(&list.content()) == vec!["bbq".to_string()] && list.size() == 1 && !list.empty()
    );
...
pub fn test_im_iter_write() {
    ...
    *list_iter.next().unwrap().borrow_mut() = "third_val".to_string();
    ...
    list = create_rc_im_list_from_vec(&vec![
        "aB".to_string(),
        "cD".to_string(),
        "i_j".to_string(),
        "gh".to_string(),
...
pub fn test_im_iter_read_write() {
    let list = create_rc_im_list_from_vec(&vec![
        "aB".to_string(),
        "cD".to_string(),
        "i_j".to_string(),
        "gh".to_string(),
    ...
    assert!(
        values(&list.content())
            == vec![
                "aB_addaB_add".to_string(),
                "cD_addcD_add".to_string(),
                "i_j_addi_j_add".to_string(),
                "gh_addgh_add".to_string(),
                "z/x_addz/x_add".to_string(),
                "QQ_addQQ_add".to_string(),
                "2_b_add2_b_add".to_string(),
                "j1_addj1_add".to_string()
            ]
            && list.size() == 8
    );
}
...
pub fn test_im_iter_with_lambda() {
    ...
    let arr: Vec<String> = list
        .iter()
        .map(|item| {
            let mut temp = item.borrow().clone();
            temp.push_str("_suff");
            temp
        })
        .collect();
    ...
    list.iter()
        .for_each(|item| item.borrow_mut().push_str("_test"));
...
pub fn test_push_front() {
    ...
    assert!(
        values(&list.content()) == vec!["second_new_val".to_string(), "bbq".to_string()]
            && list.size() == 2
    );
...
pub fn test_pop_front() {
    ...
    assert!(
        *result.unwrap().borrow() == "aB".to_string()
            && values(&list.content())
                == vec![
                    "cD".to_string(),
                    "i_j".to_string(),
    ...
    assert!(
        *result.unwrap().borrow() == "b2".to_string()
            && values(&list.content()) == vec!["d4".to_string()]
            && list.size() == 1
    );
...
pub fn test_push_back() {
    ...
    assert!(
        values(&list.content()) == vec!["bbq".to_string(), "second_new_val".to_string()]
            && list.size() == 2
    );
...
pub fn test_pop_back() {
    ...
    assert!(
        *result.unwrap().borrow() == "j1".to_string()
            && values(&list.content())
                == vec![
                    "aB".to_string(),
                    "cD".to_string(),
    ...
    assert!(
        *result.unwrap().borrow() == "d4".to_string()
            && values(&list.content()) == vec!["b2".to_string()]
            && list.size() == 1
    );
...
pub fn test_insert() {
    ...
    assert!(
        result == Err(InvalidIndex)
            && values(&list.content())
                == vec!["af".to_string(), "d_8".to_string(), "Z-4".to_string()]
            && list.size() == 3
    );
    ...
    assert!(
        result == Ok(0)
            && values(&list.content())
                == vec!["third_val".to_string(), "b2".to_string(), "d4".to_string()]
            && list.size() == 3
    );
    ...
    assert!(
        result == Ok(1)
            && values(&list.content())
                == vec!["b2".to_string(), "third_val".to_string(), "d4".to_string()]
            && list.size() == 3
    );
    ...
    assert!(
        result == Ok(2)
            && values(&list.content())
                == vec!["b2".to_string(), "d4".to_string(), "third_val".to_string()]
            && list.size() == 3
    );
    ...
    assert!(
        result == Ok(0)
            && values(&list.content()) == vec!["fourth_val".to_string(), "bbq".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        result == Ok(1)
            && values(&list.content()) == vec!["bbq".to_string(), "fourth_val".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        result == Err(InvalidIndex)
            && values(&list.content()) == vec!["bbq".to_string()]
            && list.size() == 1
    );
    ...
    assert!(
        result == Ok(0)
            && values(&list.content()) == vec!["fifth_val".to_string()]
            && list.size() == 1
    );
...
pub fn test_remove() {
    ...
    assert!(
        *result.unwrap().borrow() == "z/x".to_string()
            && values(&list.content())
                == vec![
                    "aB".to_string(),
                    "cD".to_string(),
    ...
    assert!(
        *result.unwrap().borrow() == "af".to_string()
            && values(&list.content()) == vec!["d_8".to_string(), "Z-4".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        *result.unwrap().borrow() == "d_8".to_string()
            && values(&list.content()) == vec!["af".to_string(), "Z-4".to_string()]
            && list.size() == 2
    );
    ...
    assert!(
        *result.unwrap().borrow() == "Z-4".to_string()
            && values(&list.content()) == vec!["af".to_string(), "d_8".to_string()]
            && list.size() == 2
    );
...
pub fn test_reverse() {
    ...
    assert!(
        values(&list.content()) == vec!["d4".to_string(), "b2".to_string()] && list.size() == 2
    );
...
pub fn test_merge() {
    ...
    assert!(
        values(&first_list.content()) == vec!["b2".to_string(), "d4".to_string()]
            && first_list.size() == 2
    );
    assert!(second_list.empty());
    ...
    assert!(
        values(&first_list.content())
            == vec!["b2".to_string(), "d4".to_string(), "bbq".to_string()]
            && first_list.size() == 3
    );
    assert!(second_list.empty());
    ...
    assert!(
        values(&first_list.content())
            == vec!["bbq".to_string(), "b2".to_string(), "d4".to_string()]
            && first_list.size() == 3
    );
    assert!(second_list.empty());

    first_list = create_rc_im_list_from_vec(&vec![
        "a1".to_string(),
        "b2".to_string(),
        "c3".to_string(),
        "d4".to_string(),
    ...
    second_list = create_rc_im_list_from_vec(&vec![
        "f6".to_string(),
        "g7".to_string(),
        "h8".to_string(),
        "i9".to_string(),
...
#[test]
pub fn test_split() {
    let mut first_list = create_rc_im_list_from_vec(&vec![
        "a1".to_string(),
        "b2".to_string(),
        "c3".to_string(),
        "d4".to_string(),
    ...
    assert!(
        values(&second_list.content()) == vec!["h8".to_string(), "i9".to_string()]
            && second_list.size() == 2
    );
    ...
    first_list =
        create_rc_im_list_from_vec(&vec!["b2".to_string(), "d4".to_string(), "bbq".to_string()]);
    second_list = ConsList::create();
    ...
    assert!(
        values(&second_list.content()) == vec!["d4".to_string(), "bbq".to_string()]
            && second_list.size() == 2
    );
    ...
    assert!(first_list.empty());
    assert!(
        values(&second_list.content()) == vec!["b2".to_string(), "d4".to_string()]
            && second_list.size() == 2
    );
    ...
    assert!(
        values(&first_list.content()) == vec!["a1".to_string(), "b2".to_string(), "c3".to_string()]
            && first_list.size() == 3
    );
    assert!(
        values(&second_list.content())
...
pub fn test_at_read() {
    ...
    assert!(
        values(&list.content()) == vec!["kl".to_string(), "m_n".to_string(), "O/p".to_string()]
            && list.size() == 3
    );
    ...
    assert!(
        values(&list.content()) == vec!["b2".to_string(), "d4".to_string()] && list.size() == 2
    );
...
pub fn test_at_write() {
    ...
    *list.at(2).unwrap().borrow_mut() = "o_P".to_string();
    ...
    assert!(
        values(&list.content()) == vec!["Kl".to_string(), "m/n".to_string(), "o_P".to_string()]
            && list.size() == 3
    );
    ...
    *list.at(1).unwrap().borrow_mut() = "2nd".to_string();
    ...
    assert!(
        values(&list.content()) == vec!["1st".to_string(), "2nd".to_string()] && list.size() == 2
    );
